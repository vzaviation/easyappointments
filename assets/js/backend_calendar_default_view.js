    ...
    function bindEventHandlers() {
        ...
        $calendarPage.on('click', '.edit-popover', function () {
            ...
            if (lastFocusedEventData.data.workingPlanException) {
                ...
                $dialog.find('#visitor-1-dl-number').val(appointment.visitor_1_dl_number);
                $dialog.find('#visitor-2-dl-number').val(appointment.visitor_2_dl_number);
                $dialog.find('#visitor-3-dl-number').val(appointment.visitor_3_dl_number);
                $dialog.find('#visitor-4-dl-number').val(appointment.visitor_4_dl_number);
                $dialog.find('#visitor-1-dl-state').val(appointment.visitor_1_dl_state);
